...
internal enum Asset {
  ...
  internal static let getStarted = ImageAsset(name: "getStarted")
  internal static let habitTrack = ImageAsset(name: "habitTrack")
  internal static let challengeItem = ImageAsset(name: "challengeItem")
  internal static let habitItem = ImageAsset(name: "habitItem")
  internal static let settingsItem = ImageAsset(name: "settingsItem")
